$(function () {
    "use strict";
    $(".header-message-list").length > 0 ? new PerfectScrollbar(".header-message-list") : null,
         $(".header-message-list").length > 0 ? new PerfectScrollbar(".header-notifications-list") : null,
