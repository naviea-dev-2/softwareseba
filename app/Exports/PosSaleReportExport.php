...
class PosSaleReportExport implements  FromArray , WithHeadings , WithStyles, WithCustomStartCell, WithColumnWidths, WithEvents
{
    private $data;
    private $startDate;
    private $endDate;
    ...
    public function __construct($reports , $startDate, $endDate, $company)
    {
        ...
        foreach($reports as $key=>$report)
        {
            ...
            $formattedData[] = [
                'SL'         => $key+1,
                'Date'       =>date('Y-m-d', strtotime($report->sale_date)),
                ...
                'Tax'  =>auth()->user()->currency_symbol.' '.round($report->tax, 2),
