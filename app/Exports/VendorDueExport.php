...
class VendorDueExport implements  FromArray , WithHeadings , WithStyles, WithCustomStartCell, WithColumnWidths, WithEvents
{
    private $data;
    private $startDate;
    private $endDate;
    ...
    public function __construct($reports , $startDate, $endDate, $company)
    {
        ...
        foreach($reports as $key=>$report)
        {
            ...
            $formattedData[] = [
                'SL'         => $key+1,
                'Date'       =>date('Y-m-d', strtotime($report->purchase_date)),
                'Reference'  =>$report->reference_no,
                'Supplier'   => $report->vendor_name,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->setCellValue('A5', 'Vendor Due Report')->getStyle('A5')->getFont()->setBold(true);
                $startRow = 1;
