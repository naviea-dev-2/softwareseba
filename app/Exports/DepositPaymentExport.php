...
class DepositPaymentExport implements  FromArray , WithHeadings , WithStyles, WithCustomStartCell, WithColumnWidths, WithEvents
{
    private $data;
    private $search_list;
    private $startDate;
    ...
    public function __construct($reports,$search_list , $startDate, $endDate, $company)
    {
        ...
        foreach($reports as $k=>$deposit_payment)
        {
            ...
            $formattedData[] = [
                ...
                'm_mobile'  => $deposit_payment->m_mobile,
                'p_name'  => $deposit_payment->p_name,
                'method_name'   => $deposit_payment->method_name,
