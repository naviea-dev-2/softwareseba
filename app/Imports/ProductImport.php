    ...
    WithHeadingRow
{
    ...
    public function storeProduct(): Product|Model|null
    {
       ...
       // $product = new Product();
		...
		$product->business_type_id = $this->business_type_id;
        ...
        $product->save();
        $product_stock = new ProductStock;
        $product_stock->qty = $this->request->qty ?? 0;
        $product_stock->purchase_price = $this->request->purchase_price;
        $product_stock->sale_price = $this->request->sale_price;
