...
class CurrencyController extends Controller
{
    ...
    {
        if(can_p('currency.index') == false){
            return redirect()->route('dashboard');
        }
        $data['currencies']=Currency::orderBy('id','DESC')->get();
        return view ('Inventory.currency.manage',$data);
    }
    ...
    {
        if(can_p('currency.delete') == false){
            return redirect()->route('dashboard');
        }
        try{
            DB::beginTransaction();
            ...
            return redirect()->route('currency.index')->with($notification);
