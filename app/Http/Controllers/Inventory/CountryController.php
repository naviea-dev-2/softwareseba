...
class CountryController extends Controller
{
    ...
    {
        if(can_p('country.index') == false){
            return redirect()->route('dashboard');
        }
       
        return view ('Inventory.location.country.manage');
    }
    function ajaxCountry(Request $request){
        ...
        {
           $i = $start == 0 ? 1 : $start+1;
           $p_edit = can_p('country.edit');
           $p_delete = can_p('country.delete');
    ...
    public function edit(Request $request)
    {
        ...
        return response()->json(['html' => $html,'id'=>$data->id,'name'=>$data->name,'country_code'=>$data->country_code,'currency'=>$data->currency]);
    }
