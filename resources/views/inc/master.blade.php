...
<head>
    ...
    <style>
        ...
        .topbar a { color: var(--header_font_color); }
        .topbar .navbar .navbar-nav .nav-link { color: var(--header_font_color); }
        .topbar .navbar .dropdown-menu {
            background: var(--header_back_color);
            color: var(--header_font_color);
        }
        .topbar .dropdown-item:focus .msg-info, .dropdown-item:hover .msg-info { color: #000; }
        .topbar .dropdown-item:focus .msg-name, .dropdown-item:hover .msg-name { color: #000; }
        .topbar .dropdown-item:focus .msg-time, .dropdown-item:hover .msg-time { color: #000; }
