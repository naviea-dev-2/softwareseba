            ...
            <table class="table" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                @foreach($reports as $key=>$report)
                  ...
                  <tr>
                    <td>{{$key+1}}</td>
                    <td style="text-align:left;">{{ date('Y-m-d', strtotime($report->damage_date)) }}</td>
                    <td style="text-align:left;">{{$report->damage_from}}</td>
                    
                    <td style="text-align:left;">{{$report->product_name}}</td>
                    <td>{{$report->qty}}</td>
