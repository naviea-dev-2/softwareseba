                    ...
                    @csrf
                        ...
                        <div class="row notReg" style="background-color: rgb(13 152 152 / 46%)">
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="text" class="w-100" name="email" id="email" value="{{ old('email') }}" placeholder="Username" autocomplete="off">
                            </div>
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <div class="input-group" id="show_hide_password">
                                    ...
                                    name="password" placeholder="Enter Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class="fas fa-eye-slash"></i></a>
                                </div>
                            ...
                            <div class="col-12">
                                <button type="submit"  class="float-right regbutton">Sign In</button>
                            </div>
                        </div>
                    </form>
                </div>
