            ...
            <div class="container-fluid mt-2" style="background:#ffffff;dmin-height: 55px;padding: 13px 25px;">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('deposit.create') }}" class="btn btn-primary" ><i class="bx bx-plus"></i> Add Deposit</a>
                    </div>
                </div>
                                    ...
                                    <div class="row mt-0">
                                        ...
                                        <div class="col-sm-2 mt-3 show_date_wise">
                                            ...
                                            <div class="mg-t-10 mg-sm-t-0">
                                                <input type="text" name="from_date" id="from_date" class="form-control fl-datepicker" value="{{old('date')}}"/>
                                        ...
                                        <div class="col-sm-2 mt-3 show_date_wise">
                                            ...
                                            <div class="mg-t-10 mg-sm-t-0">
                                                <input type="text" name="to_date" id="to_date" class="form-control fl-datepicker" value="{{old('date')}}"/>
                                        ...
                                        <div class="col-sm-2 mt-3">
                                            ...
                                            <div class="mg-t-10 mg-sm-t-0">
                                                <select  class="form-control" name="member" id="f_member">
...
<script>
    ...
    function ajaxMigrateStudent(page,per_page){
        ...
        data.append( 'member',$("#f_member").val());
        ...
        data.append( 'member_text',$("#f_member option:selected").text());
    ...
    select2Deposit('#f_member','{{route('select2.member')}}','Select Land Plot');
    ...
    $(document).on('click','.property_del_data',function(){
        ...
        Swal.fire({
		    ...
		    if (result.value) {
                window.location = "{{ url('deposit-delete') }}/"+id;
            }
        });
    });
