@if($deposit_payments->count() > 0)
    ...
    <div class="d-flex justify-content-between">
        ...
        <div class="d-flex">
            ...
            <form action="{{ route('deposit.list.export') }}" method="GET">
                ...
                <input type="hidden" value="{{ $member }}" name="p_member" class="p_member">
                ...
                <input type="hidden" value="{{ $member_text }}" name="p_member_text" class="p_member_text">
            ...
            <form action="{{ route('deposit.list.export') }}" target="__blank" method="GET">
        ...
        <table id="dataTable" class="purchase-list table table-striped table-bordered" style="width:100%;border: 1px solid #dee2e6;">
            <thead>
                <tr>
                    ...
                    <th style="width:10%;">Member Mobile</th>
