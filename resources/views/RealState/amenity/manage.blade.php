...
<title>Manage Property Amenity</title>
<style>
    label{
        font-size: 1.2rem;
    }
            ...
            <div class="row row-card-one">
                <div class="col-sm-12 ">
                    <div class="row report-title">
                        <h4 class=" "><b>Property Amenity</b> </h4>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <h5 class="modal-title" id="exampleModalLabel" style="color:white;line-height:18px;">Add Property Amenity</h5>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row row-card-one">
                                            <div class="col-sm-12">
                                                ...
                                                <form method="POST" action="{{route('property_amenity.store')}}" enctype="multipart/form-data" class="add_data_form">
                                                    @csrf
                                                    <div class="row">
...
<script>
    var d_table = $('#amenity_dataTable').DataTable({
        ...
        "scrollX": true,
        "ajax":{
            "url": "{{ route('property_amenity.ajax') }}",
            "dataType": "json",
            "type": "POST",
            data: function(data){
    ...
    $(document).on("click",'.amenity_data_edit',function(){
        ...
        $.ajax({
            url: "{{route('property_amenity.edit') }}?id=" + id,
            method: 'GET',
    ...
    $(document).on('click','.amenity_del_data',function(){
        ...
        Swal.fire({
		    ...
		    if (result.value) {
                window.location = "{{ url('property-amenity-delete') }}/"+id;
            }
        });
    });
    //add data
