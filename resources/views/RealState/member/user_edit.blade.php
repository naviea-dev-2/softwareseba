...
<div class="content-area" >
        ...
        <div class="row row-card-one">
            <div class="col-sm-12 ">
                <div class="row report-title">
                    <h5 style="font-size: 0.875rem; margin:0;">Edit Profile</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row" style="padding-top: 24px;">
        <div class="col-sm-12">
            <!-- start form here -->
            <form method="POST" action="{{route('user.member.update',$member->id)}}" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="mt-1 mr-2" style="position:relative;box-shadow: 0px 0px 1px 1px;width: 150px;">
                                        <img class="display-upload-img-add" style="width: 150px;height: 70px;" src="{{ $member->image_show }}" alt="">
