        ...
        <div class="content-area">
            <div class="container-fluid mt-2" style="background:#ffffff;dmin-height: 55px;padding: 13px 25px;">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h5 style="font-size: 0.875rem; margin:0;">Member</h5>
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('member.create') }}" class="btn btn-primary" ><i class="bx bx-plus"></i> Add Member</a>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-lg-12 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="member_dataTable" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>SN.</th>
                                        <th>Image</th>
...
<script>
    ...
    $(document).on('click','.member_del_data',function(){
