...
<Form class="form form-horizontal custom-form-horizontal">
<div class="card">
            ...
            <div class="row">
              <div class="col-12">
                <div class="form-group row">
                    <Label class="control-label col-md-4">Business Loog</Label>
              ...
              <div class="col-6">
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input type="text" name="business_name" class="form-control {{ $errors->has('business_name') ? 'is-invalid' : '' }}" placeholder="Business Name">
              ...
              <div class="col-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="email_address" class="form-control {{ $errors->has('email_address') ? 'is-invalid' : '' }}" placeholder="Email Address">
                  ...
                  <div class="col-md-8">
                    <Select name="organization_type_id" class="form-control select2 {{ $errors->has('organization_type_id') ? 'is-invalid' : '' }}">
                        ...
                        @foreach ($type_of_orgs as $k=>$type_of_org)
                            <option value="{{ $k }}">{{ $type_of_org }}</option>
                        @endforeach
                    </Select>
                    ...
                    <div div class="col-md-8">
                        <Select name="business_type_id" class="form-control select2 {{ $errors->has('business_type_id') ? 'is-invalid' : '' }}">
                            ...
                            @foreach ($business_types as $k=>$business_type)
                                <option value="{{ $k }}">{{ $business_type }}</option>
                            @endforeach
                        </Select>
                    ...
                    @endphp
                     <Select name="timezone_id" class="form-control select2">
                        @foreach ($timezones as $k=>$timezone)
                            <option value="{{ $k }}">{{ $timezone }}</option>
                        @endforeach
                     </Select>
              ...
              <div class="col-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="postal_or_zip_code" class="form-control" placeholder="Postal Zip Code">
                    </div>
            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="mobile_phone" class="form-control" placeholder="Mobile Phone">
                    </div>
                </div>
              </div><!--/.col-6-->
...
<script type="text/javascript">
  $(function(){
    ...
    $(document.body).on('change', '#country_id', function(){
      ...
      $("#state_id").html('<option value="">{{__('lang.please_wait')}}....</option>');
      $.ajax({
    ...
    $(document.body).on('change', '#state_id', function(){
      ...
      $("#city_id").html('<option value="">{{__('lang.please_wait')}}....</option>');
      $.ajax({
...
<script type="text/javascript">
  ...
  $(function(){
    var business_logo = $(".business_logo-dropzone").dropzone({
      ...
      dictRemoveFileConfirmation: '{{__("lang.are_you_sure")}}',
