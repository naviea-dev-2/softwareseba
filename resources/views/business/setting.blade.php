...
<Form action="{{ route('business_setting',$business->id) }}" method="POST" class="form form-horizontal custom-form-horizontal" enctype="multipart/form-data">
    @csrf
<div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="mt-1 mr-2" style="position:relative;box-shadow: 0px 0px 1px 1px;width: 100px;">
                                <img class="display-upload-img-add" style="width: 100px;height: 70px;" src="{{ $business->business_logo_show }}" alt="">
            ...
            <div class="row mt-2">
                ...
                <div class="col-6">
                    <div class="form-group row">
                        <Label class="control-label col-md-4">Type Of Business ss *</Label>
            ...
            <div class="row mt-2">
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            @php
                                $countries = \App\Models\Inventory\Country::options()
                            @endphp
                            <Select name="country_id" id="country_id" class="form-control select2">
                                @foreach ($countries as $k=>$country)
                                    @if(old('country_id'))
                                    <option @if(old('country_id') == $k) selected @endif value="{{ $k }}">{{ $country }}</option>
                                    @else
                                    <option @if($business->country_id == $k) selected @endif  value="{{ $k }}">{{ $country }}</option>
                                    @endif
                                @endforeach
                            </Select>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="phone_number" class="form-control" placeholder="Phone" value="{{ old('phone_number') ? old('phone_number') : $business->phone_number }}">
                        </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="fax" class="form-control" placeholder="Fax" value="{{ old('fax') ? old('fax') : $business->fax }}">
                        </div>
                ...
                <div class="col-6">
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="mobile_phone" class="form-control" placeholder="Mobile Phone" value="{{ old('mobile_phone') ? old('mobile_phone') : $business->mobile_number }}">
                        </div>
                    </div>
                </div><!--/.col-6-->
                ...
                <div class="col-6">
                    <div class="form-group row mt-2">
                        <Label class="control-label col-md-4">Currency ssss</Label>
                        <div class="col-md-8">
...
<script type="text/javascript">
  $(function(){
    ...
    $(document).find('#currency').select2({
    ...
    $(document).find('#state_id').select2({
        placeholder: 'Select State',
        allowClear: true,
        width:'100%',
        dropdownAutoWidth : true,
    ...
    @if(old('state_id'))
    var state_option = new Option("{{ old('state_id_h') }}","{{ old('state_id')}}", true, true);
    $('#state_id').append(state_option).trigger('change');
    @else
    var state_option = new Option("{{ $business->state->name }}","{{ $business->state_id }}", true, true);
    $('#state_id').append(state_option).trigger('change');
    @endif

    $(document).find('#city_id').select2({
    ...
    @if(old('city_id'))
    var city_option = new Option("{{ old('city_id_h') }}","{{ old('city_id')}}", true, true);
    $('#city_id').append(city_option).trigger('change');
    @else
    var city_option = new Option("{{ $business->city->name }}","{{ $business->city_id }}", true, true);
    $('#city_id').append(city_option).trigger('change');
    @endif
