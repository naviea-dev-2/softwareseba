			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div class="card-body tabs-area p-0">
						...
						<div class="tabs-body">
							<!--Data Entry Form-->
							<form action="{{ route('post.business_setting',$business->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mt-2">
                                    <div class="col-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <Select name="organization_type_id" class="form-control select2_i {{ $errors->has('organization_type_id') ? 'is-invalid' : '' }}">
                                                    @php
                                                        $type_of_orgs = [
                                                            ''=>'-- Type Of Organiztion --',
                                    ...
                                    <div class="col-6">
                                        <div class="form-group row">
                                            ...
                                            <div div class="col-md-8">
                                                <Select name="business_type_id" class="form-control select2_i {{ $errors->has('business_type_id') ? 'is-invalid' : '' }}">
                                                    @php
                                                    $business_types = [
                                    ...
                                    <div class="col-6">
                                        ...
                                        <Label class="control-label col-md-4">Time Zone</Label>
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                @endphp
                                                <Select name="timezone_id" id="timezone_id" class="form-control select2_i">
...
<script type="text/javascript">
    ...
    select2Init('#city','{{route('select2.cities.byState')}}','Select City',null,"state");
    $('.select2_i').select2();
    ...
    @if($business->country_id > 0)
        var country_option = new Option("{{$business->country?->name}}","{{$business->country_id}}", true, true);
        $('#country').append(country_option).trigger('change');
    @endif
    @if($business->state_id > 0)
    ...
    @endif
    @if($business->currency_id > 0)
        var currency_option = new Option("{{$business->currency?->name}}","{{$business->currency_id}}", true, true);
