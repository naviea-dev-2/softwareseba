...
<head>
    ...
    <title>Invoice Return Report Print</title>
    <style>
        table{
            width: 100%;
            margin-bottom: 1rem;
            ...
            <div class="card-body">
                    ...
                    <div class="account-main-title mb-5">
                        <div class="" style="text-align: center">
                            ...
                            <h4 style="padding: 0;margin:0;margin-bottom:10px;">Invoice Return Report</h4>
                        ...
                        <table class="table table-flush mt-3" id="report-dataTable">
                            ...
                            <tbody>
                                ...
                                @endphp
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td>{{ date('Y-m-d', strtotime($report->return_date)) }}</td>
