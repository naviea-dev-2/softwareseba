                ...
                <div class="row row-card-one">
                    <div class="col-sm-12 ">
                        <div class="row report-title">
                            <h4 class=""><b>User Manage</b></h4>
                        </div>
                    </div>
                </div>
            </div>

            <div class="container pt-0 mt-0" style="box-shadow: 0 0 2px gray;border-top:4px solid gray;">
                <div class=" my-4 py-2">
...
$(document).on('click','.del_data_user',function(){
        ...
        Swal.fire({
		    ...
		    if (result.value) {
                window.location = "{{ url('business/user/delete') }}/"+id;
            }
        });
    });
