        ...
        <div class="br-section-wrapper pt-4">
            <div class="row">
                <div class="col-md-10">
                        ...
                        <h6 class="br-section-label text-center mb-1">Voucher Entry (Journal)</h6>
                                    ...
                                    <div class="col-sm-12 mt-2">
                                        <table class="table table-bordered" >
                                            ...
                                            <tfoot class="thead-colored thead-info ">
                                                <input type="hidden" id="total_amount_dr_input" name="total_amount_dr_input" value="0">
                                                <input type="hidden" id="total_amount_cr_input" name="total_amount_cr_input" value="0">
                                                <tr>
                                                    <th style="background-color: #17a2b8;text-align: right;color:white;font-weight:bold;font-size:15px;">Total</th>
                                                    <th style="background-color: #17a2b8;text-align: right;color:white;font-weight:bold;font-size:15px;" id="total_amount_dr">0.00</th>
                                                    <th style="background-color: #17a2b8;text-align: right;color:white;font-weight:bold;font-size:15px;" id="total_amount_cr">0.00</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click','#cus-submit-btn',function(){
                ...
                data.append( 'journal_date',$("#p_date").val());
