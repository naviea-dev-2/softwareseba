...
@extends('inc.master')
@section('head')
<title>Voucher Entry (Debit)</title>
<style>
  .hidden {
      display: none;
  }
        ...
        <div class="br-section-wrapper pt-4">
            <div class="row">
                <div class="col-md-8">
                        ...
                        <h6 class="br-section-label text-center mb-1">Voucher Entry (Debit)</h6>
...
<script src="{{ asset('public/assets/js') }}/sweetalert2.all.min.js"></script>
    <script>
        $(document).ready(function() {
            ...
            select2Exam('.a-payment','{{route('select2.ledger')}}?acc_c_id=[5,6,7]','Select Ledger');
            ...
            $(document).on('click','#cus-submit-btn',function(){
                ...
                data.append( 'v_type','Debit Voucher');
