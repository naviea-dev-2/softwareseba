...
<div class="br-mainpanel">
    <div class="br-pagebody">
        <div class="br-section-wrapper data-update pt-4">
            <div class="row">
                <div class="col-md-10">
                    <h6 class="br-section-label text-center mb-1">Edit Voucher Entry (Contra)</h6>
                        ...
                        <form id="data-form-create" action="{{ route('account.voucher.update',$voucher->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mt-2">
                                    ...
                                    <div class="mg-t-10 mg-sm-t-0">
                                        <input type="number" name="trans_amount" value="{{ $voucher->voucher_amount }}" id="trans_amount" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 mt-2">
                                    ...
                                    <div class="mg-t-10 mg-sm-t-0">
                                        <input type="text" name="ref" id="ref" value="{{ $voucher->ref }}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-12 mt-2">
