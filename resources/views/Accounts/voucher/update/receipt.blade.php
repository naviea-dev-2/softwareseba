...
<div class="br-section-wrapper data-update pt-4">
    <div class="row">
        <div class="col-md-8">
                ...
                <h6 class="br-section-label text-center mb-1">Edit Voucher Entry (Credit Voucher)</h6>
                                        ...
                                        @foreach ($voucher->details as $detail)
                                            <tr>
                                                ...
                                                <td style="padding: 5px;vertical-align:middle;text-align:center;">
                                                    <div>
                                                        <button type="button" class="btn btn-success add_row btn-sm "><i class="bs bx-plus-circle"></i> </button>
