                                       ...
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    <form method="POST" action="{{route('city.store')}}" enctype="multipart/form-data" class="add_data_form">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                       ...
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    <form method="POST" action="{{route('city.store')}}" enctype="multipart/form-data" class="edit_data_form">
                                                        @csrf
                                                        <div class="row">
...
<script>
    ...
    select2Init('#add_select2_country',$('#exampleModal'),'{{route('select2.countries')}}','Select Country');
    select2Init('#country',$('#updateModal'),'{{route('select2.countries')}}','Select Country');

    select2Init('#add_select2_state',$('#exampleModal'),'{{route('select2.states.bycountry')}}','Select State','add_select2_country');
    ...
    //     data: function (params) {
    //       return {
    //         country_id : $("#add_select2_country").val(),
    //         value: $.trim(params.term),
    //       };
    //     },
    //     processResults: function (response) {
    ...
    $(document).on('click','.del_data',function(){
        ...
        Swal.fire({
		    ...
		    if (result.value) {
                window.location = "{{ url('city-delete') }}/"+id;
            }
        });
    });
    //add data
