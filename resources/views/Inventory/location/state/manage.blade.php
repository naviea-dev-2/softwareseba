                                       ...
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    <form method="POST" action="{{route('state.store')}}" enctype="multipart/form-data" class="add_data_form">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                       ...
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    <form method="POST" action="{{route('state.store')}}" enctype="multipart/form-data" class="edit_data_form">
                                                        @csrf
                                                        <div class="row">
...
<script>
    ...
    $(document).on('click','.del_data',function(){
        ...
        Swal.fire({
		    ...
		    if (result.value) {
                window.location = "{{ url('state-delete') }}/"+id;
            }
        });
    });
    //add data
