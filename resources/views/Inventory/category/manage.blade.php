                                       ...
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    <form method="POST" action="{{route('category.store')}}" enctype="multipart/form-data" class="add_data_form">
                                                        @csrf
                                                        <div class="row">
                                       ...
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    <form method="POST" action="{{route('category.store')}}" enctype="multipart/form-data" class="edit_data_form">
                                                        @csrf
                                                        <div class="row">
                        ...
                        <div class="container pt-0">
                            <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                              ...
                              <tbody id="filterItemShow">
                                 @php
                                    $p_edit = can_p('category.edit');
                                    $p_delete = can_p('category.delete');
                                @endphp
                                ...
                                <tr class="{{$category->id}}">
                                   ...
                                   <td>
                                        ...
                                        @endif
                                        @if($p_delete)
                                        <a href="#" data-token="{{csrf_token()}}" data-id="{{$category->id}}" class="del_data btn btn-danger">
