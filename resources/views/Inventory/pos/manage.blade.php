                ...
                <div class="row row-card-one">
                    <div class="col-sm-12 ">
                        <div class="row report-title">
                            <h4 class="my-1"><b>POS Sales Manage</b></h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container pt-0" style="box-shadow: 0 0 2px gray;border-top:4px solid gray;margin-top:5px;">
                <div class="row row-card-one my-1">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        ...
                        {{-- <a class="btn btn-primary" href="{{ route('pos.create') }}"><i class="fa fa-plus" ></i> New Sale</a> --}}
                        @include('Inventory.pos.show-details')
...
<script>
    ...
    $(document).on('click','.view',function(){
        ...
        $('#print-btn').attr('pos_id',id);
        $.ajax({
            url: "{{url('pos-invoice-detail') }}/"+id,
            method: 'GET',
