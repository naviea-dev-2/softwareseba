<div class="row">
    <div class="col-lg-4">
        <div class="form-group">
            ...
            <input value="{{ $product ? $product->purchase_price : 0 }}" name="cost_price" id="edit_cost_price" type="text" class="form-control parsley-validated">
        </div>
    </div>
    <div class="col-lg-4">
        <div class="form-group">
            <label for="sale_price">{{ __('Sale Price') }}<span class="red">*</span></label>
            <input value="{{ $product ? $product->sale_price : $o0 }}" name="sale_price" id="edit_sale_price" type="text" class="form-control parsley-validated" data-required="true">
        </div>
    </div>
    {{-- <div class="col-lg-4">
        <div class="form-group">
