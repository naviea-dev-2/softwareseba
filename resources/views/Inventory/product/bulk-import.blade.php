			...
			<div class="col-lg-12">
				<div class="card">
                    ...
                    <div class="card-body tabs-area p-0">
                        <form action="{{ route('product.import') }}" method="POST" class="form-import-data" enctype="multipart/form-data">
                            @csrf
                                            ...
                                            <div class="form-group mb-3 @if ($errors->has('file')) has-error @endif">
                                                ...
                                                <div class="mt-3 text-center p-2 border bg-light">
                                                    <a
                                                        ...
                                                        data-url="{{ route('import_download_template') }}"
                                                        data-extension="csv"
