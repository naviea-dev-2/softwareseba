            ...
            <div class="container pt-0" style="box-shadow: 0 0 2px gray;border-top:4px solid gray;">
                <div class="row row-card-one my-2">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        ...
                        @endif
                        @php
                            $p_edit = can_p('road.edit');
                            $p_delete = can_p('road.delete');
                        @endphp
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                  <div class="modal-header" style="background-color:#01303f;max-height: 50px;">
                                    <h5 class="modal-title" id="exampleModalLabel" style="color:white;line-height:18px;">Add Road</h5>
                                       ...
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    <form method="POST" action="{{route('road.store')}}" enctype="multipart/form-data" class="add_data_form">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-sm-6">
                        ...
                        <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                  <div class="modal-header" style="background-color:#01303f;max-height: 50px;">
                                    <h5 class="modal-title" id="exampleModalLabel" style="color:white;line-height:18px;">Update Road</h5>
                                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
                                  </div>
                                       ...
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    <form method="POST" action="{{route('road.store')}}" enctype="multipart/form-data" class="edit_data_form">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <label for="">Territory *</label>
                                                                <input type="hidden" value="0" name="id"  required>
                                                                <select name="territory" id="edit_territory" class="form-control">
                                                                </select>
                                                                <span class="invalid-feedback mb-0">
                                                                </span>
                                                            </div>
                              ...
                              <tbody id="filterItemShow">
                                ...
                                <tr class="{{$road->id}}">
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @if($p_delete)
                                        <a href="#" data-token="{{csrf_token()}}" data-id="{{$road->id}}" class="del_data btn btn-danger">
...
<script>
    ...
    $('.data_edit').on('click',function(){
        ...
        $.ajax({
            url: "{{route('road.edit') }}?id=" + id,
            method: 'GET',
            success: function(data) {
                // $('#fetchDepartment').html(data.html);
                $('#name').val(data.name);
                $('#data_id').val(data.id);
                var territory_option = new Option(data.territory_name,data.territory_id, true, true);
                $('#edit_territory').append(territory_option).trigger('change');
            }
        });
    });
    $(document).on('click','.del_data',function(){
        ...
        Swal.fire({
		    ...
		    if (result.value) {
                window.location = "{{ url('road-delete') }}/"+id;
            }
        });
    });
    //add data
