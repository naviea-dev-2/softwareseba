 ...
 @section('content')
        <div class="content-area">
           <div class="container-fluid">
                <div class="row row-card-one">
                    <div class="col-sm-12 ">
                        <div class="row report-title">
                            <h4 class=" "><b>Currency Manage</b> </h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container py-0" style="box-shadow: 0 0 2px gray;border-top:4px solid gray;">
                <div class="row row-card-one py-1">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <!-- start modal -->
                        <!-- Button trigger modal -->
                        @if(can_p('currency.add'))
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                  <div class="modal-header" style="background-color:#01303f;max-height: 50px;">
                                    <h5 class="modal-title" id="exampleModalLabel" style="color:white;line-height:18px;">Add Currency</h5>
                                   ...
                                   <div class="modal-body">
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    <form method="POST" action="{{route('currency.store')}}" enctype="multipart/form-data" class="add_data_form">
                                                        @csrf
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                ...
                                                                <input type="text" class=" form-control form-control-sm"  name="symbol" autocomplete="off" required>
                                                                <span class="invalid-feedback mb-0">
                                                                </span>
                                                            </div>
                        ...
                        <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                  <div class="modal-header" style="background-color:#01303f;max-height: 50px;">
                                    <h5 class="modal-title" id="exampleModalLabel" style="color:white;line-height:18px;">Update Currency</h5>
                                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
                                  </div>
                                       ...
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    <form method="POST" action="{{route('currency.store')}}" enctype="multipart/form-data" class="edit_data_form">
                                                        @csrf
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                ...
                                                                <input type="text" class=" form-control form-control-sm" id="symbol" name="symbol" autocomplete="off" required>
                                                                <span class="invalid-feedback mb-0">
                                                                </span>
                                                            </div>
                        ...
                        <div class="container p-0">
                            <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                              ...
                              <tbody id="filterItemShow">
                                @php
                                    $p_edit = can_p('currency.edit');
                                    $p_delete = can_p('currency.delete');
                                @endphp
                                @foreach($currencies as $key=>$currency)
                                <tr class="{{$currency->id}}">
                                   <td>{{$key+1}}</td>
                                   <td>{{$currency->name}}</td>
                                   ...
                                   <td>
                                        ...
                                        @endif
                                        @if($p_delete)
                                        {{-- <a href="#" data-token="{{csrf_token()}}" data-id="{{$currency->id}}" class="del_data btn btn-danger">
...
<script>
    ...
    $(document).on('click','.del_data',function(){
        ...
        Swal.fire({
		    ...
		    if (result.value) {
                window.location = "{{ url('currency-delete') }}/"+id;
            }
        });
    });
    //add data
