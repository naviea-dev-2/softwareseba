...
<title>Manage Purchase Return</title>
<style>
    label{
        font-size: 1.2rem;
    }
                ...
                <div class="row row-card-one">
                    <div class="col-sm-12 ">
                        <div class="row report-title">
                            <h4 class=""><b>Purchase Return Manage</b></h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container pt-0" style="box-shadow: 0 0 2px gray;border-top:4px solid gray;">
                <div class="row row-card-one my-1">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        ...
                        @endphp
                        @include('Inventory.purchase_return.show-invoice-details')
                        @include('Inventory.purchase_return.add-modal-payment')
                        @include('Inventory.purchase_return.show-payment-modal')
                        <div style="display: none;">
                            @include('Inventory.purchase_return.payment_print')
                        </div>
                        <br/>
...
<script>
    $('#dataTable').DataTable({
        ...
        "scrollX": true,
        "ajax":{
            "url": "{{ route('purchase_return.ajax') }}",
            "dataType": "json",
            "type": "POST",
            data: function(data){
    ...
    $(document).on('click','.view',function(){
        ...
        $.ajax({
            url: "{{url('purchase-return-detail') }}/"+id,
            method: 'GET',
    ...
    $(".add_payment_data_form").on('submit', function(){
     ...
     $(document).on('click','.payment_show',function(){
        ...
        var id = $(this).attr('data-id');
        $.ajax({
            url: "{{url('purchase-return-payment-show') }}/"+id,
            method: 'GET',
