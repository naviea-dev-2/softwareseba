                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6 text-left">
                            <div class="receipt-right">
                                <h6>{{$purchase_return->vendor?->name}} </h6>
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="receipt-left">
                                ...
                                <p style="margin: 0px;"><b>Date :</b> {{\Carbon\Carbon::parse($purchase_return->purchase_date)->format('d M, Y')}}</p>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p>
                                        <strong><i class="fa fa-inr"></i> {{ auth()->user()->currency_symbol }}{{  round($purchase_return->shipping_cost,2) }}</strong>
                                    </p>
                                    <p>
                                        <strong><i class="fa fa-inr"></i> {{ auth()->user()->currency_symbol }}{{  round($purchase_return->total_tax,2) }}</strong>
                                    </p>
                                    <p>
                                        <strong><i class="fa fa-inr"></i>{{ auth()->user()->currency_symbol }}{{  round($d_total,2) }}</strong>
                                    </p>
                                    <p>
                                        <strong><i class="fa fa-inr"></i>{{ auth()->user()->currency_symbol }}{{  round($p_total+ $purchase_return->total_tax+ $purchase_return->shipping_cost-$purchase_return->order_discount,2) }}</strong>
                                    </p>
                                    <p>
                ...
                <div class="row">
                    <div class="receipt-header receipt-header-mid receipt-footer">
                        <div class="col-xs-12 col-sm-12 col-md-12 text-left">
                            <div class="receipt-right">
                                <p><b>Note :</b>{{$purchase_return->note}}</p>
