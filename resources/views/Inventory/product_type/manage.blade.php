                ...
                <div class="row row-card-one">
                    <div class="col-sm-12 ">
                        <div class="row report-title ">
                            <h4 class=" "><b>Product Type Manage</b> </h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container pt-0" style="box-shadow: 0 0 2px gray;border-top:4px solid gray;">
                <div class="row row-card-one my-4">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        ...
                        @endif
                        @php
                            $p_edit = can_p('p_type.edit');
                            $p_delete = can_p('p_type.delete');
                        @endphp
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                  <div class="modal-header" style="background-color:#01303f;max-height: 50px;">
                                    <h5 class="modal-title" id="exampleModalLabel" style="color:white;line-height:18px;">Add Product Type</h5>
                                       ...
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    <form method="POST" action="{{route('p_type.store')}}" enctype="multipart/form-data" class="add_data_form">
                                                        @csrf
                                                        <div class="row">
                        ...
                        <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                  <div class="modal-header" style="background-color:#01303f;max-height: 50px;">
                                    <h5 class="modal-title" id="exampleModalLabel" style="color:white;line-height:18px;">Update Product Type</h5>
                                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
                                  </div>
                                       ...
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    <form method="POST" action="{{route('p_type.store')}}" enctype="multipart/form-data" class="edit_data_form">
                                                        @csrf
                                                        <div class="row">
                              ...
                              <tbody id="filterItemShow">
                                ...
                                <tr class="{{$p_type->id}}">
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        @if($p_delete)
                                        <a href="#" data-token="{{csrf_token()}}" data-id="{{$p_type->id}}" class="del_data btn btn-danger">
...
<script>
    ...
    $(document).on('click','.del_data',function(){
        ...
        Swal.fire({
		    ...
		    if (result.value) {
                window.location = "{{ url('p_type-delete') }}/"+id;
            }
        });
    });
    //add data
