                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                  <div class="modal-header" style="background-color:#01303f;max-height: 50px;">
                                    <h5 class="modal-title" id="exampleModalLabel" style="color:white;line-height:18px;">Add Vendor</h5>
                                   ...
                                   <div class="modal-body">
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                   <!-- start form here -->
                                                    <form method="POST" action="{{route('vendor.store')}}" enctype="multipart/form-data" class="add_data_form">
                                                        @csrf
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <select id="add_select_country" class="form-control select_country" name="country">
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <select id="add_select_state" class="form-control select_state" name="state">
                                                                    <option value="">-- Select One --</option>
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <select id="add_select_city"  class="form-control select_city" name="city">
                                                                      <option value="">-- Select One --</option>
                        ...
                        <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                  <div class="modal-header" style="background-color:#01303f;max-height: 50px;">
                                    <h5 class="modal-title" id="exampleModalLabel" style="color:white;line-height:18px;">Edit Vendor</h5>
                                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
                                  </div>
                                   <div class="modal-body">
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                   <!-- start form here -->
                                                    <form method="POST" action="{{route('vendor.store')}}" enctype="multipart/form-data" class="edit_data_form">
                                                        @csrf
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <label for="">Country</label>
                                                                <select class="form-control select_country" name="country" id="country" >
                                                                    <option value="">-- Select One --</option>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <label for="">Vendor Image</label>
                                                                <div class="mt-1 mr-2" style="position:relative;box-shadow: 0px 0px 1px 1px;width: 150px;">
                                                                    <img class="display-upload-img" style="width: 150px;height: 70px;" id="edit_image" src="{{ asset("public/images/No-image.jpg")}}" alt="">
                                                                    <input id="edit_image_upload" type="file" name="image" class="form-control upload-img" placeholder="Enter Activity Image" style="position: absolute;top: 0;opacity: 0;height: 100%;">
                                                                    <span class="invalid-feedback mb-0"></span>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-3">
...
<script>
    ...
    select2Init('#country',$( '#updateModal' ),'{{route('select2.countries')}}','Select Country');

    select2Init('#add_select_state',$( '#exampleModal' ),'{{route('select2.states.bycountry')}}','Select State',"add_select_country");
    select2Init('#state',$( '#updateModal' ),'{{route('select2.states.bycountry')}}','Select State',"country");
    ...
    $(document).on('click','.data_edit',function(){
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#edit_image').attr('src',data.image);
    ...
    $(document).on('click','.del_data',function(){
        ...
        Swal.fire({
            ...
            if (result.value) {
                window.location = "{{ url('vendor-delete') }}/"+id;
            }
        });
    });
    //add data
