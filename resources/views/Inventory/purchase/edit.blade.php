                ...
                <div class="card-body pt-0">
                    ...
                    <div class="row p-1">
                        <div class="col-md-3">
                            ...
                            <input value="{{ $purchase->vendor?->name }}" type="text" class=" form-control  vendor-auto-search" name="name" autocomplete="off">
                        ...
                        <div class="col-md-3">
                            ...
                            <input value="{{ $purchase->vendor?->mobile }}" type="number" class=" form-control  vendor-auto-search" name="mobile" autocomplete="off">
                        </div>

                        <div class="col-md-3">
                            <label for=""><b>Company Address</b></label>
                            <input value="{{ $purchase->vendor?->address }}" type="text" class=" form-control  vendor-auto-search" name="address" autocomplete="off">
                        </div>
                    </div>
                    <div class="row p-1">
                        <div class="col-md-3">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="hidden" name="h_branch" id="h_branch" value="{{  old('h_branch',$purchase->branch?->name)  }}"/>
                        ...
                        @else
                            <div class="col-sm-3">
                                <label for=""><b>Branch</b></label>
                                <input type="text" disabled value="{{$purchase->branch?->name}}"/>

                                <input type="hidden" value="{{$purchase->branch_id}}" name="branch">
                            </div>
                        @endif
                        <div class="col-md-3">
                            ...
                            <select name="status" class="form-control  mb-0">
                                <option @if($purchase->status == 1) selected @endif value="1">Received</option>
...
<script>
    ...
    @if(auth()->user()->user_type == 0 || auth()->user()?->role?->is_admin == 1)
        ...
        @if($purchase->branch_id)
            var branch_option = new Option("{{ old('h_branch',$purchase->branch?->name) }}","{{ old('branch',$purchase->branch_id) }}", true, true);
    ...
    function priceCalculation(){
        ...
        var shipping_cost= $('#sub_shipping_cost').val() || 0;
       ...
       due_amount =due_amount.toFixed(2);
        ...
        //  console.log(shipping_cost.toFixed(2));
    ...
    @if($purchase->items->count() > 0)
        ...
        FillProductOption("{{$item->product_id}}",p_row_no,"{{ $item->id }}","{{ $item->qty }}",unit_option);
             p_row_no++;
        @endforeach
    ...
    @else
        var bank_account_option = new Option("{{ $purchase->account?->account_name }}","{{ $purchase->bank_account_id }}", true, true);
        $('#add_account').append(bank_account_option).trigger('change');
    @endif
</script>
@endsection
