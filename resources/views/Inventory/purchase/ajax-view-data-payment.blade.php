        ...
        <tbody>
            ...
            <tr>
                ...
                @php
                    ...
                    $d_p['code']=$purchase?->reference_no;
                    $d_p['c_name']=$purchase->vendor?->name;
                    $d_p['c_mobile']=$purchase->vendor?->mobile;
                    $d_p['c_email']=$purchase->vendor?->email;
                    $d_p['c_address']=$purchase->vendor?->address;
