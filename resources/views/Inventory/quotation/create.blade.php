                ...
                <div class="card-body pt-0">
                    ...
                    <div class="row p-1">
                        <div class="col-md-3">
                            ...
                            <input type="text" class=" form-control  vendor-auto-search" name="name" autocomplete="off" required value="{{old('name')}}">

                        </div>
                        <div class="col-md-3">
                            <label for=""><b>Customer Email</b></label>
                            <input type="email" class=" form-control  vendor-auto-search" name="email" autocomplete="off" value="{{ old('email') }}">
                        </div>
                        <div class="col-md-3">
                            <label for=""><b>Customer Mobile</b></label>
                            <input type="number" class=" form-control  vendor-auto-search" name="mobile" autocomplete="off" required value="{{ old('mobile') }}">
                        </div>

                        <div class="col-md-3">
                            <label for=""><b>Customer Address</b></label>
                            <input type="text" class=" form-control  vendor-auto-search" name="address" autocomplete="off" required value="{{ old('address') }}">
                        </div>
                    </div>
                    <div class="row p-1">
                        <div class="col-md-3">
                            <label for=""><b>Quotation Date</b></label>
                            <input type="text" class=" form-control  datepicker" value="{{ date('Y-m-d') }}" name="quotation_date" autocomplete="off" required name="{{ old('quotation_date') }}">
                        </div>
