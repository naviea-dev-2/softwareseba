            ...
            <div class="receipt-main" id="print-details">
                ...
                <div class="receipt-header">
                    ...
                    <div class="receipt-right" style="text-align: center;">
                        <h5 style="font-size: 16px;font-weight: bold;margin: 0 0 7px 0;">{{ auth()->user()->business->business_name }}</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="receipt-left">
                                ...
                                <p style="margin: 0px;"><b>Date :</b> {{\Carbon\Carbon::parse($quotation->invoice_date)->format('d M, Y')}}</p>
                            </div>
                        </div>
                    </div>
                </div>
