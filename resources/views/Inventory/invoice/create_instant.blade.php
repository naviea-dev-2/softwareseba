...
<title>Create Instant Sales</title>
<style>
    .auto-search{
        width: 100%;
        display: block;
...
<div class="container pt-0" style="box-shadow: 0 0 2px gray;border-top:4px solid gray;margin-top:0px; padding-bottom:30px;padding-left:10px;">
    <h4>Add Instant Sale</h4>
    <form action="{{ route('invoice.store_instant') }}" method="post">
        @csrf
                ...
                <div class="card-body pt-0">
                    ...
                    {{-- <div class="row p-1">
                        <div class="col-md-3">
                            ...
                            <input type="text" class=" form-control vendor-auto-search" name="name" autocomplete="off" value="{{old('name')}}">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class=" form-control vendor-auto-search" name="mobile" autocomplete="off" value="{{ old('mobile') }}">
                        </div>

                        <div class="col-md-3">
                            <label for=""><b>Customer Address</b></label>
                            <input type="text" class=" form-control vendor-auto-search" name="address" autocomplete="off" value="{{ old('address') }}">
                        </div>
                    </div> --}}
                    <div class="row p-1">
                        <div class="col-md-3">
                        ...
                        @if($b_type_id == 15)
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="hidden" name="h_dsr" id="h_dsr" value="{{  old('h_dsr')  }}"/>
                            ...
                            {{-- <div class="col-sm-3">
                                ...
                                <input type="hidden" name="h_asr" id="h_asr" value="{{  old('h_asr')  }}"/>
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="hidden" name="h_driver" id="h_driver" value="{{  old('h_driver')  }}"/>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="status" class="form-control mb-0">
                                <option @if(old('status') == 1) selected @endif value="1">Received</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class=" form-control datepicker" value="{{ date('Y-m-d') }}" name="deadline_date" autocomplete="off" name="{{ old('deadline_date') }}">
                        </div>
                        @endif
                    </div>
                    <div class="row p-1">
            ...
            <div class="card-content p-3">
                <div class="container-fluid">
                    <table class="order-list table-responsive table-bordered table-sm text-center nowrap" cellspacing="0" width="100%">
                        ...
                        <tfoot class="tfoot active d-none">
                                ...
                                {{-- <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <Select class="form-control {{ $errors->has('payment_status') ? 'is-invalid' : '' }}" name="payment_status" id="payment_status">
                                            <option @if(old('payment_status') == 0) selected @endif value="0">Due</option>
                                            <option @if(old('payment_status') == 1) selected @endif value="1">Partial</option>
                                            <option @if(old('payment_status') == 2) selected @endif value="2">Paid</option>
                                        </Select>
...
<script>
    ...
    @if(auth()->user()->business->business_type_id == 15)
        @if(array_search('hr-payroll',load_pack_option()) != false)
            ...
            var dsr_option = new Option("{{ old('h_dsr') }}","{{ old('dsr')}}", true, true);
            ...
            var asr_option = new Option("{{ old('h_asr') }}","{{ old('asr')}}", true, true);
            ...
            var driver_option = new Option("{{ old('h_driver') }}","{{ old('driver')}}", true, true);
