        ...
        <div class="row">
            ...
            <div class="receipt-main" id="print-details">
                ...
                <div class="btn-action">
                    ...
                    <a href="{{route('invoice.create_instant')}}" style="border:1px solid #c4c4c4" class="btn btn-default btn-sm d-print-none">Back</a>
                    {{-- <button id="back-btn" type="button" class="btn btn-default btn-sm d-print-none"><i class="bx bx-printer"></i> Back </button> --}}
                </div>
