        ...
        <tbody>
            ...
            <tr>
                ...
                @php
                    ...
                    $d_p['code']=$payment->invoice?->reference_no;
                    $d_p['c_name']=$invoice->customer?->name;
                    $d_p['c_mobile']=$invoice->customer?->mobile;
                    $d_p['c_email']=$invoice->customer?->email;
                    $d_p['c_address']=$invoice->customer?->address;
