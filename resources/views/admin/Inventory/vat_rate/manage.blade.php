                ...
                <div class="row row-card-one py-4">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <form method="POST" action="{{route('admin.tax.store')}}" enctype="multipart/form-data" class="add_data_form">
                                @csrf
                                <div class="row">
                        ...
                        <form method="POST" action="{{route('admin.tax.store')}}" enctype="multipart/form-data" class="edit_data_form">
                            @csrf
                            <div class="row">
...
<script>
    ...
    $('.data_edit').on('click',function(){
        ...
        console.log(id);
        $.ajax({
            url: "{{route('admin.tax.edit') }}?id=" + id,
            method: 'GET',
    ...
    $(document).on('click','.del_data',function(){
        ...
        Swal.fire({
		    ...
		    if (result.value) {
                window.location = "{{ url('admin/tax-delete') }}/"+id;
            }
        });
    });
    //add data
