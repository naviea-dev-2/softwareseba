 <!-- start form here -->
<form method="POST" action="{{route('admin.attributes.saveAttributesData')}}" enctype="multipart/form-data"  @if($is_add == 0) class="edit_data_form" @else class="add_data_form" @endif>
    @csrf
    <div class="row">
        @if($is_add == 0)
        ...
        <div class="col-sm-3" @if($is_add == 1) id="exampleModalSelect" @else id="updateModalSelect" @endif  style="position: relative;">
            <label for="">Business *</label>
            <Select @if($is_add == 1) id="business_id" @else id="edit_business_id" @endif name="business_id" class="form-control select2">
