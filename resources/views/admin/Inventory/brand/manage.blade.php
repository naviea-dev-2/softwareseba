                                       ...
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    <form method="POST" action="{{route('admin.brand.store')}}" enctype="multipart/form-data" class="add_data_form">
                                                        @csrf
                                                        <div class="row">
                                       ...
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    <form method="POST" action="{{route('admin.brand.store')}}" enctype="multipart/form-data" class="edit_data_form">
                                                        @csrf
                                                        <div class="row">
...
<script>
    ...
    $(document).on('click','.data_edit',function(){
        ...
        $.ajax({
            url: "{{route('admin.brand.edit') }}?id=" + id,
            method: 'GET',
    ...
    $(document).on('click','.del_data',function(){
        ...
        Swal.fire({
		    ...
		    if (result.value) {
                window.location = "{{ url('adnin/brand-delete') }}/"+id;
            }
        });
    });
    //add data
