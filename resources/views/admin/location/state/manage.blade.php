                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                  <div class="modal-header" style="background-color:#01303f;max-height: 50px;">
                                    <h5 class="modal-title" id="exampleModalLabel" style="color:white;line-height:18px;">Add States</h5>
                                       ...
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    <form method="POST" action="{{route('admin.state.store')}}" enctype="multipart/form-data" class="add_data_form">
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <label for="">Country *</label>
                                                                <select class="form-control add_select_country" name="country" required>
                        ...
                        <div class="modal fade" id="updateModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                  <div class="modal-header" style="background-color:#01303f;max-height: 50px;">
                                    <h5 class="modal-title" id="exampleModalLabel" style="color:white;line-height:18px;">Update State</h5>
                                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true" >&times;</span>
                                    </button>
                                  </div>
                                       ...
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    <form method="POST" action="{{route('admin.state.store')}}" enctype="multipart/form-data" class="edit_data_form">
                                                        @csrf
                                                        <div class="row">

                                                            <div class="col-sm-6">
                                                                <label for="">Country *</label>
                                                                <select class="form-control select_country" name="country" id="country" required>
                                                                    <option value="">-- Select One --</option>
...
<script>
    ...
    select2Init('.add_select_country',$( '#exampleModal' ),'{{route('admin.select2.countries')}}','Select Country');
    select2Init('#country',$( '#updateModal' ),'{{route('admin.select2.countries')}}','Select Country');
    function select2Init(source,modal,url,place_holder,country_id=0,state_id=0){
        $(source).select2({
            theme: "bootstrap-5",
    ...
    $(document).on('click','.data_edit',function(){
        ...
        $.ajax({
            url: "{{route('admin.state.edit') }}?id=" + id,
            method: 'GET',
    ...
    $(document).on('click','.del_data',function(){
        ...
        Swal.fire({
		    ...
		    if (result.value) {
                window.location = "{{ url('admin/state-delete') }}/"+id;
            }
        });
    });
    //add data
