...
<Form action="{{ route('admin.add_business_post') }}" method="POST" class="form form-horizontal custom-form-horizontal" enctype="multipart/form-data">
    @csrf
<div class="card">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="mt-1 mr-2" style="position:relative;box-shadow: 0px 0px 1px 1px;width: 150px;">
                                <img class="display-upload-img-add" style="width: 150px;height: 70px;" src="{{ $business->no_image }}" alt="">
            ...
            <div class="row mt-2">
                ...
                <div class="col-6 mt-2">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="address_line_1" class="form-control"  value="{{ old('address_line_1') ? old('address_line_1') : $business->address1 }}">
                ...
                <div class="col-6 mt-2">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="address_line_2" class="form-control" value="{{ old('address_line_2') ? old('address_line_2') : $business->address2 }}">
                        </div>
                    </div>
                </div><!--/.col-6-->
                ...
                <div class="col-6 mt-2">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="postal_or_zip_code" class="form-control" value="{{ old('postal_or_zip_code') ? old('postal_or_zip_code') : $business->post_code }}" placeholder="Postal Zip Code">
                        </div>
            ...
            <div class="row">
              <div class="col-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="number" name="phone_number" class="form-control" placeholder="Phone" value="{{ old('phone_number') ? old('phone_number') : $business->phone_number }}">
                    </div>
              ...
              <div class="col-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="number" name="fax" class="form-control" placeholder="Fax" value="{{ old('fax') ? old('fax') : $business->fax }}">
                    </div>
              ...
              <div class="col-6">
                <div class="form-group row mt-2">
                    ...
                    <div class="col-md-8">
                        <input type="number" name="mobile_phone" class="form-control" placeholder="Mobile Phone" value="{{ old('mobile_phone') ? old('mobile_phone') : $business->mobile_number }}">
                    </div>
                </div>
              </div><!--/.col-6-->
              ...
              <div class="col-6">
                <div class="form-group row mt-2">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="website" class="form-control" placeholder="Website" value="{{ old('website') ? old('website') : $business->website }}">
                    </div>
                </div>
              </div><!--/.col-6-->
                <div class="col-6">
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-md-8">
                            <Select id="user_type" name="user_type" class="form-control">
                                <option @if(old('user_type') == 0) selected @endif value="0">Free</option>
                                <option @if(old('user_type') == 1) selected @endif value="1">Paid</option>
                            </Select>
                        </div>
                    </div>
                </div><!--/.col-6-->
                <div class="col-6 package_show" @if(old('user_type') != 1) style="display:none;" @endif>
                    <div class="form-group row mt-2">
...
<script type="text/javascript">
  $(function(){
    ...
    @if(old('country_id'))
        var currency_option = new Option("{{old('h_country') }}","{{ old('country_id') }}", true, true);
        $('#country_id').append(currency_option).trigger('change');
    @endif
    @if(old('state_id'))
        var currency_option = new Option("{{old('h_state') }}","{{ old('state_id') }}", true, true);
        $('#state_id').append(currency_option).trigger('change');
    @endif
    @if(old('city_id'))
        var currency_option = new Option("{{old('h_city') }}","{{ old('city_id') }}", true, true);
        $('#city_id').append(currency_option).trigger('change');
    @endif
    @if(old('currency'))
    ...
    @endif
    @if(old('package'))
        var currency_option = new Option("{{old('h_package') }}","{{ old('package') }}", true, true);
        $('#package').append(currency_option).trigger('change');
    @endif
