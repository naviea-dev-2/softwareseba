...
<Form action="{{ route('admin.edit_business_post',$business->id) }}" method="POST" class="form form-horizontal custom-form-horizontal" enctype="multipart/form-data">
    @csrf
<div class="card">
  ...
  <div class="card-content">
    <div class="card-body p-0">
        ...
        <div class="card-content">
          <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <div class="form-group row">
                        <Label class="control-label col-md-4">Business Logo</Label>

                        <div class="col-md-8">
                            <p>Browse Your Logo Here. <p>Max file 5MP in size.</p><p>JPG, PNG and GIF fomat.</p><p>Recommended size 300px X 200px.</p></p>
                            <div class="mt-1 mr-2" style="position:relative;box-shadow: 0px 0px 1px 1px;width: 150px;">
                                <img class="display-upload-img-add" style="width: 150px;height: 70px;" src="{{ $business->business_logo_show }}" alt="">
            ...
            <div class="row mt-2">
                <div class="col-6">
                    <div class="form-group row">
                        <Label class="control-label col-md-4">Business Name *</Label>

                        <div class="col-md-8">
                            <input type="text" name="business_name" value="{{ old('business_name') ? old('business_name') : $business->business_name }}" class="form-control {{ $errors->has('business_name') ? 'is-invalid' : '' }}" placeholder="Business Name">
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="email_address" class="form-control {{ $errors->has('email_address') ? 'is-invalid' : '' }}" placeholder="Email Address" value="{{ old('email_address') ? old('email_address') : $business->email }}">
            ...
            <div class="row mt-2">
                <div class="col-6">
                    <div class="form-group row">
                        <Label class="control-label col-md-4">Type Of Organization *</Label>
                        <div class="col-md-8">
                            <Select name="organization_type_id" class="form-control select2 {{ $errors->has('organization_type_id') ? 'is-invalid' : '' }}">
                                @php
                                    $type_of_orgs = [
                                        ''=>'-- Type Of Organiztion --',
                                ...
                                @endphp
                                @foreach ($type_of_orgs as $k=>$type_of_org)
                                    @if(old('organization_type_id'))
                                    <option @if(old('organization_type_id') == $k) selected @endif value="{{ $k }}">{{ $type_of_org }}</option>
                                    @else
                                    <option @if($business->oranization_id == $k) selected @endif  value="{{ $k }}">{{ $type_of_org }}</option>
                                    @endif
                                @endforeach
                            </Select>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <div div class="col-md-8">
                            <Select name="business_type_id" class="form-control select2 {{ $errors->has('business_type_id') ? 'is-invalid' : '' }}">
                                @php
                                    $business_types = [
                                ...
                                @endphp
                                @foreach ($business_types as $k=>$business_type)
                                    @if(old('business_type_id'))
                                    <option @if(old('business_type_id') == $k) selected @endif value="{{ $k }}">{{ $business_type }}</option>
                                    @else
                                    <option @if($business->business_type_id == $k) selected @endif  value="{{ $k }}">{{ $business_type }}</option>
                                    @endif
            ...
            <div class="row mt-2">
                        ...
                        <div class="col-md-8">
                            ...
                            <Select name="timezone_id" class="form-control select2">
                                @foreach ($timezones as $k=>$timezone)
                                    @if(old('timezone_id'))
                                    <option @if(old('timezone_id') == $k) selected @endif value="{{ $k }}">{{ $timezone }}</option>
                                    @else
                                    <option @if($business->timezone_id == $k) selected @endif  value="{{ $k }}">{{ $timezone }}</option>
                                    @endif
                ...
                {{-- <div class="col-6">
                    ...
                    <div class="col-md-8">
                        {{Form::select('currency_id', App\Models\Settings\Currency::options(), null, ['class'=>'form-control select2'])}}
                    </div>
                    </div>
                </div><!--/.col-6--> --}}
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="hidden" id="h_country" name="h_country" value="{{old('h_country')}}" />
            ...
            <div class="row mt-2">
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="hidden" id="h_state" name="h_state" value="{{old('h_state')}}" />
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="hidden" id="h_city" name="h_city" value="{{old('h_city')}}" />
            ...
            <div class="row mt-2">
                <div class="col-6">
                    <div class="form-group row">
                        <Label class="control-label col-md-4">Addres Line 1</Label>
                        <div class="col-md-8">
                            <input type="text" name="address_line_1" class="form-control"  value="{{ old('address_line_1',$business->address1) }}">
                ...
                <div class="col-6">
                    <div class="form-group row">
                        <Label class="control-label col-md-4">Addres Line 2</Label>
                        <div class="col-md-8">
                            <input type="text" name="address_line_2" class="form-control" value="{{ old('address_line_2',$business->address2) }}">
                        </div>
                    </div>
                </div><!--/.col-6-->
            </div>
            <div class="row mt-2">
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="postal_or_zip_code" class="form-control" value="{{ old('postal_or_zip_code',$business->post_code) }}" placeholder="Postal Zip Code">
                        </div>
      ...
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Additional Infomation</h4>
        </div>
        <div class="card-content">
          <div class="card-body">
            <div class="row">
              <div class="col-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="number" name="phone_number" class="form-control" placeholder="Phone" value="{{ old('phone_number',$business->phone_number) }}">
                    </div>
              ...
              <div class="col-6">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="number" name="fax" class="form-control" placeholder="Fax" value="{{ old('fax',$business->fax) }}">
                    </div>
              ...
              <div class="col-6">
                <div class="form-group row mt-2">
                    ...
                    <div class="col-md-8">
                        <input type="number" name="mobile_phone" class="form-control" placeholder="Mobile Phone" value="{{ old('mobile_phone', $business->mobile_number) }}">
                    </div>
                </div>
              </div><!--/.col-6-->
              ...
              <div class="col-6">
                ...
                <div class="col-6">
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-md-8">
                            <input type="hidden" id="h_currency" name="h_currency" value="{{old('h_currency')}}" />
                ...
                <div class="col-6 @if(old('user_type',$business->user_type) == 1) d-none @endif">
                    <div class="form-group row mt-2">
                        <Label class="control-label col-md-4">Service Start Date</Label>
                        <div class="col-md-8">
                            <input class="form-control" name="start_date" type="date" value="{{old('start_date',\Carbon\Carbon::parse($business->start_date)->format('Y-m-d'))}}">
                        </div>
                    </div>
                </div><!--/.col-6-->
                <div class="col-6">
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-md-8">
                            <Select id="user_type" name="user_type" class="form-control select2" disabled>
                                <option @if(old('user_type',$business->user_type) == 0) selected @endif value="0">Free</option>
                                <option @if(old('user_type',$business->user_type) == 1) selected @endif value="1">
                                @if(\Carbon\Carbon::now()->lte($business->pack_end_date))
                                Paid
                                @else
                                Expired
                                @endif
                ...
                <div class="col-6 package_show" @if(old('user_type',$business->user_type) != 1) style="display:none;" @endif>
                    <div class="form-group row mt-2">
                        <Label class="control-label col-md-4">Package</Label>
                        <div class="col-md-8">
                            <input type="hidden" id="h_package" name="h_package" value="{{old('h_package')}}" />
                            <Select id="package" name="package" class="form-control" disabled>
                ...
                <div class="col-6 package_show" @if(old('user_type',$business->user_type) != 1) style="display:none;" @endif>
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-md-8">
                            <input disabled class="form-control" id="end_date" name="end_date" type="date" value="{{old('start_date',\Carbon\Carbon::parse($business->end_date)->format('Y-m-d'))}}">
                        </div>
                    </div>
                </div><!--/.col-6-->
                <div class="card-btns mt-4" style="text-align: right;">
...
<script type="text/javascript">
    $(function(){
        $('#country_id').select2({
            ...
            ajax: {
                url: '{{route('admin.select2.countries')}}',
                dataType: 'json',
                delay: 250,
        ...
        $('#state_id').select2({
            ...
            containerCssClass: 'select-sm',
            ajax: {
                url: '{{route('admin.select2.states.bycountry')}}',
                dataType: 'json',
                delay: 250,
                data: function (params) {
                return {
        ...
        $('#city_id').select2({
            ...
            containerCssClass: 'select-sm',
            ajax: {
                url: '{{route('admin.select2.cities.byState')}}',
                dataType: 'json',
                delay: 250,
                data: function (params) {
                return {
        ...
        $('#currency').select2({
            ...
            containerCssClass: 'select-sm',
            ajax: {
                url: '{{route('admin.select2.currency')}}',
                dataType: 'json',
                delay: 250,
                data: function (params) {
                return {
        ...
        @if(old('country_id'))
            var country_option = new Option("{{old('h_country') }}","{{ old('country_id') }}", true, true);
            $('#country_id').append(country_option).trigger('change');
        @else
            var country_option = new Option("{!! $business->country?->name !!}","{{ $business->country_id == 0 ? '' : $business->country_id }}", true, true);
            $('#country_id').append(country_option).trigger('change');
        @endif
        @if(old('state_id'))
            var state_option = new Option("{{old('h_state') }}","{{ old('state_id') }}", true, true);
            $('#state_id').append(state_option).trigger('change');
        @else
            var state_option = new Option("{!! $business->state?->name !!}","{{ $business->state_id == 0 ? '' : $business->state_id }}", true, true);
            $('#state_id').append(state_option).trigger('change');
        @endif
        @if(old('city_id'))
            var city_option = new Option("{{old('h_city') }}","{{ old('city_id') }}", true, true);
            $('#city_id').append(city_option).trigger('change');
        @else
            var city_option = new Option("{!! $business->city?->name !!}","{{ $business->city_id == 0 ? '' : $business->city_id }}", true, true);
            $('#city_id').append(city_option).trigger('change');
        @endif
        @if(old('currency'))
            var currency_option = new Option("{{old('h_currency') }}","{{ old('currency') }}", true, true);
            $('#currency').append(currency_option).trigger('change');
        @else
        console.log( '{{$business->currency?->name}}' );
            var currency_option = new Option("{!! $business->currency?->name !!}","{{ $business->currency_id == 0 ? '' : $business->currency_id }}", true, true);
            $('#currency').append(currency_option).trigger('change');
        @endif
        @if(old('package'))
        ...
        @else
            ...
            var package_option = new Option( "{!! $business->package?->name !!}","{{ $business->package_id == 0 ? '' :   $business->package_id}}", true, true);
            $('#package').append(package_option).trigger('change');
        @endif
