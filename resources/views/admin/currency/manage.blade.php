                                  ...
                                  <div class="modal-header" style="background-color:#01303f;max-height: 50px;">
                                   ...
                                   <div class="modal-body">
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    <form method="POST" action="{{route('admin.currency.store')}}" enctype="multipart/form-data" class="add_data_form">
                                                        @csrf
                                                        <div class="row">
                                       ...
                                       <div class="container-fluid">
                                            <div class="row row-card-one">
                                                <div class="col-sm-12">
                                                    ...
                                                    <form method="POST" action="{{route('admin.currency.store')}}" enctype="multipart/form-data" class="edit_data_form">
                                                        @csrf
                                                        <div class="row">
...
<script>
    ...
    $('.data_edit').on('click',function(){
        ...
        $.ajax({
            url: "{{route('admin.currency.edit') }}?id=" + id,
            method: 'GET',
    ...
    $(document).on('click','.del_data',function(){
        ...
        Swal.fire({
		    ...
		    if (result.value) {
                window.location = "{{ url('admin/currency-delete') }}/"+id;
            }
        });
    });
    //add data
