...
<Form action="{{ route('admin.user.add') }}" method="POST" class="form form-horizontal custom-form-horizontal" enctype="multipart/form-data">
    @csrf
<div class="card">
        ...
        <div class="row mt-2">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="number" name="mobile" class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" placeholder="Mobile Number" value="{{ old('mobile') ? old('mobile') : $user->mobile }}">
             ...
             <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="password" name="password" class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" placeholder="password" value="{{ old('password') ? old('password') : $user->password }}">
