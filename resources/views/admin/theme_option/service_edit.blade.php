			...
			<div class="col-lg-12">
				<div class="card">
                    ...
                    <div class="card-body tabs-area p-0">
						...
						<div class="tabs-body">
                            <form action="{{ route('backend.update_soft_service',$software_service->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group">
											<label for="custom_js">{{ __('Title') }}</label>
											<input value="{{ old('title') ?? $software_service->title }}" type="text" name="title" class="form-control" placeholder="Title">

										</div>
                                        @error('title')
                                            <span class="invalid-feedback mb-0 d-block">
                                    ...
                                    <div class="col-lg-6">
										<div class="form-group">
											...
											<input value="{{ old('url') ?? $software_service->url }}" type="text" name="url" class="form-control" placeholder="URL">
										</div>
                                        @if($errors->has('url'))
                                            <span class="invalid-feedback mb-0 d-block">
                                    ...
                                    {{-- <div class="col-md-4 mt-3">
										...
										<div class="form-group">
											...
											<div class="mt-1 mr-2" style="position:relative;box-shadow: 0px 0px 1px 1px;width: 76px;">
                                                <img class="display-upload-img" style="width: 76px;height: 70px;" src="{{ $software_service->image_show }}" alt="">
