...
<div class="main-body">
	<div class="container-fluid">
		...
		<div class="row mt-25">
			<div class="col-lg-12">
				<div class="card">
					<div class="card-header theme-option-header">{{ __('Custom JS') }}</div>
					<div class="card-body tabs-area p-0">
						@include('admin.theme_option.partials.theme_options_tabs_nav')
						<div class="tabs-body">
							<!--Custom JS-->
							<form action="{{ route('backend.saveCustomJS') }}" method="post" enctype="multipart/form-data">
                                @csrf
								<div class="row">
									<div class="col-lg-12">
