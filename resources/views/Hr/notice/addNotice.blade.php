        ...
        <div class="br-section-wrapper pt-4">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <h6 class="br-section-label text-center mb-1">Add Notice</h6>
                    <div id="create_errors"></div>

                    <div class="form-layout form-layout-4 pt-1 pb-0" style="border: 1px solid;padding: 10px;">

                        <form id="data-form-create" action={{ route('storeNotice') }} method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mt-2">
                                    ...
                                    <select name="notice" class="form-control @error('notice') is-invalid @enderror" id="notice">
                                        ...
                                        <option @if(old('notice') == 'Daily Notice') selected @endif value="Daily Notice">Daily Notice</option>
                                        <option @if(old('notice') == 'Monthly Notice') selected @endif value="Monthly Notice">Monthly Notice</option>
                                        <option @if(old('notice') == 'Yearly Notice') selected @endif value="Yearly Notice">Yearly Notice</option>
                                        <option @if(old('notice') == 'Instant Notice') selected @endif value="Instant Notice">Instant Notice</option>
                                    </select>
                                    @error('notice')
                                ...
                                <div class="col-sm-12 mt-2">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" rows="2" name="description" id="description">{{ old("description") }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mt-3 mb-3">
                                ...
                                <button type="submit" class="btn btn-info" id="cus-submit-btn">Save</button>
                                </div>
                            </div>
                        </form>
