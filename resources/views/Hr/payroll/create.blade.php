        ...
        <div class="br-section-wrapper pt-4">
            <div class="row">
                <div class="col-md-8">
                        ...
                        <h6 class="br-section-label text-center mb-1">Add Payroll</h6>
                            ...
                            <form action="{{route('storePayroll')}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mt-2">
                                        ...
                                        <input type="number" value="{{ old("house_rent") }}" placeholder="House Rent" name="house_rent" id="house_rent" class="form-control @error('house_rent') is-invalid @enderror" >
                                        @error('house_rent')
                                    ...
                                    <div class="col-sm-6 mt-2">
                                        ...
                                        <input type="number" value="{{ old("medical_cost") }}" placeholder="Medical Cost" name="medical_cost" id="medical_cost" class="form-control @error('medical_cost') is-invalid @enderror" >
                                        @error('medical_cost')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-sm-6 mt-2">
                                        ...
                                        <input type="number" value="{{ old("transport_cost") }}" placeholder="Transpot Cost" name="transport_cost" id="transport_cost" class="form-control @error('transport_cost') is-invalid @enderror" >
                                    ...
                                    <div class="col-sm-6 mt-2">
                                        ...
                                        <input type="number" value="{{ old("tax") }}" placeholder="Transpot Cost" name="tax" id="tax" class="form-control @error('tax') is-invalid @enderror" >
                                        @error('tax')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-sm-6 mt-2">
                                        ...
                                        <input type="number" value="{{ old("provident_fund") }}" placeholder="Provident Fund" name="provident_fund" id="provident_fund" class="form-control @error('provident_fund') is-invalid @enderror" >
