        ...
        <div class="br-section-wrapper pt-4">
            <div class="row">
                <div class="col-md-8">
                        ...
                        <h6 class="br-section-label text-center mb-1">Edit Late Roll</h6>
                            ...
                            <form action="{{route('updateLateRoll',$p->id)}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mt-2">
                                        ...
                                        <input type="number" value="{{ old("late",$p->late) }}" placeholder="Late Day" name="late" id="late" class="form-control @error('late') is-invalid @enderror" >
                                        @error('late')
                                    ...
                                    <div class="col-sm-6 mt-2">
                                        ...
                                        <input type="number" value="{{ old("absent",$p->absent) }}" placeholder="Absent Count" name="absent" id="absent" class="form-control @error('absent') is-invalid @enderror" >
                                        @error('absent')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
