        ...
        <div class="br-section-wrapper pt-4">
            <div class="row">
                <div class="col-md-4">
                        ...
                        <h6 class="br-section-label text-center mb-1">Edit Department</h6>
                        <div id="create_errors"></div>

                        <div class="form-layout form-layout-4 pt-1 pb-0" style="border: 1px solid;padding: 10px;">

                            <form action="{{ route('updateDepartment',$dept->id) }}" method="post">
                              @csrf
                              <div class="row">
                                <div class="col-sm-12 mt-2">
                                  <label class="form-control-label">Name: <span class="tx-danger">*</span></label>
                                  <input type="text" value="{{ old("name",$dept->name) }}" placeholder="Enter Name" name="name" id="name" class="form-control @error('name') is-invalid @enderror">
                                  @error('name')
