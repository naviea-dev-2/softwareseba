        ...
        <div class="br-section-wrapper pt-4">
            <div class="row">
                <div class="col-md-8">
                        ...
                        <h6 class="br-section-label text-center mb-1">Edit Absent</h6>
                            ...
                            <form action="{{route('updateAbsent',$p->id)}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mt-2">
                                        ...
                                        <input type="number" value="{{ old("first",$p->first) }}" placeholder="First Absent Amount (%)" name="first" id="first" class="form-control @error('first') is-invalid @enderror" >
                                        @error('first')
                                    ...
                                    <div class="col-sm-6 mt-2">
                                        ...
                                        <input type="number" value="{{ old("other",$p->other) }}" placeholder="Other Absent Amount (%)" name="other" id="other" class="form-control @error('other') is-invalid @enderror" >
                                        @error('other')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
