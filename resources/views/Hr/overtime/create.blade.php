        ...
        <div class="br-section-wrapper pt-4">
            <div class="row">
                <div class="col-md-8">
                        ...
                        <h6 class="br-section-label text-center mb-1">Add Over Time</h6>
                            ...
                            <form action="{{route('storeOvertime')}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mt-2">
                                        ...
                                        <input type="number" value="{{ old("hour") }}" placeholder="Unit Hour " name="hour" id="hour" class="form-control @error('hour') is-invalid @enderror" >
                                        @error('hour')
                                    ...
                                    <div class="col-sm-6 mt-2">
                                        ...
                                        <input type="number" value="{{ old("amount") }}" placeholder=">Amount For Unit Hour (%)" name="amount" id="amount" class="form-control @error('amount') is-invalid @enderror" >
                                        @error('amount')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
