...
<title>Employee Loan Report</title>
<style>
    .dtable-footer {
        display: flex;
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="d-flex">
                                ...
                                @endif
                                @if(can_p('report_emp_loan_print'))
                                ...
                                @endif
                                @if(can_p('report_emp_loan_excel'))
                        ...
                        <table id="dataTable" class="purchase-list table table-striped table-bordered" style="width:100%">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $report->type }}</td>
                                <td>{{ auth()->user()->currency_symbol.' '.round($dr,2) }}</td>
                                <td>{{ auth()->user()->currency_symbol.' '.round($cr,2) }}</td>
                                <td>{{ auth()->user()->currency_symbol.' '.round($balance,2) }}</td>

                            </tr>
                           @endforeach
                           <tr>
                            <td colspan="5">Total</td>
                            <td>{{ auth()->user()->currency_symbol.' '.round($debit,2) }}</td>
                            <td>{{ auth()->user()->currency_symbol.' '.round($credit,2) }}</td>
                            <td>{{ auth()->user()->currency_symbol.' '.round($balance,2) }}</td>
                           </tr>
