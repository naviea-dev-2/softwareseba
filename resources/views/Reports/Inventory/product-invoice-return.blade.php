...
<title>Invoice Return Report</title>
                ...
                <div class="row row-card-one">
                    <div class="col-sm-12 ">
                        <div class="row report-title">
                            <h4 class=""><b>Invoice Return Report</b></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row row-card-one my-4">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        ...
                        <div class="search-Section">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <select id="select_dsr" class="form-control " name="dsr">
                                ...
                                {{-- <div class="col-sm-3">
                                    <label for=""><b>ASR</b></label>
                                    
                                    <select id="select_asr" class="form-control " name="asr">
                                        <option value="">-- Select One --</option>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <select id="select_driver" class="form-control " name="driver">
                                        <option value="">-- Select One --</option>
                        ...
                        <div class="d-flex justify-content-between">
                            <div></div>
                            <div class="d-flex">
                                @if(can_p('invoice_return_report_pdf'))
                                <form action="{{ route('invoice_return_report_pdf') }}" method="GET">
                                    ...
                                    <input type="hidden" value="{{request()->dsr}}" name="p_dsr">
                                    <input type="hidden" value="{{request()->asr}}" name="p_asr" >
                                    <input type="hidden" value="{{request()->driver}}" name="p_driver">
                                    <button type="submit" class="btn btn-primary px-4 ms-2">PDF</button>
                                </form>
                                @endif
                                @if(can_p('invoice_return_report_print'))
                                <form action="{{ route('invoice_return_report_print') }}" method="GET">
                                    <input type="hidden" value="{{ $from_date }}" name="p_from_date" class="p_from_date">
                                    <input type="hidden" value="{{ $to_date }}" name="p_to_date" class="p_to_date">
                                    <input type="hidden" value="{{request()->customer}}" name="p_customer" class="p_vendor">
                                    <input type="hidden" value="{{request()->category}}" name="p_category" class="p_category">
                                ...
                                @endif
                                @if(can_p('invoice_return_report_excel'))
                                <form action="{{ route('invoice_return_report_excel') }}" method="GET">
                                    <input type="hidden" value="{{ $from_date }}" name="p_from_date" class="p_from_date">
                                    <input type="hidden" value="{{ $to_date }}" name="p_to_date" class="p_to_date">
                                    <input type="hidden" value="{{request()->customer}}" name="p_customer" class="p_vendor">
                                    <input type="hidden" value="{{request()->category}}" name="p_category" class="p_category">
