                ...
                <div class="row row-card-one">
                    <div class="col-sm-12 ">
                        <div class="row report-title">
                            <h4 class=""><b>Damage Product Report</b></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row row-card-one my-2">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        ...
                        <div class="d-flex justify-content-between">
                            <div></div>
                            <div class="d-flex">
                                @if(can_p('damage_product_report_pdf'))
                                <form action="{{ route('damage_product_report_pdf') }}" method="GET">
                                ...
                                @endif
                                @if(can_p('damage_product_report_print'))
                                <form action="{{ route('damage_product_report_print') }}" method="GET">
                                    <input type="hidden" value="{{ $from_date }}" name="p_from_date" class="p_from_date">
                                    <input type="hidden" value="{{ $to_date }}" name="p_to_date" class="p_to_date">
                                    <input type="hidden" value="{{request()->category}}" name="p_category" class="p_category">
                                    <input type="hidden" value="{{request()->product}}" name="p_product" class="p_product">
                                ...
                                @endif
                                @if(can_p('damage_product_report_excel'))
                                <form action="{{ route('damage_product_report_excel') }}" method="GET">
                                    <input type="hidden" value="{{ $from_date }}" name="p_from_date" class="p_from_date">
                                    <input type="hidden" value="{{ $to_date }}" name="p_to_date" class="p_to_date">
                                    <input type="hidden" value="{{request()->category}}" name="p_category" class="p_category">
                                    <input type="hidden" value="{{request()->product}}" name="p_product" class="p_product">
