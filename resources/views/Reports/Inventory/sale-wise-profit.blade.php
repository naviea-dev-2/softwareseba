...
<title>Sale Wise Profit Report</title>
                ...
                <div class="row row-card-one">
                    <div class="col-sm-12 ">
                        <div class="row report-title">
                            <h4 class=""><b>Sale Wise Profit Report</b></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row row-card-one my-4">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        ...
                        <div class="d-flex justify-content-between">
                            <div></div>
                            <div class="d-flex">
                                @if(can_p('sale_wise_profit_report_pdf'))
                                <form action="{{ route('sale_wise_profit_report_pdf') }}" method="GET">
                                    ...
                                    <input type="hidden" value="{{request()->customer}}" name="p_customer" class="p_customer">
                                    <input type="hidden" value="{{request()->dsr}}" name="p_dsr">

                                    <button type="submit" class="btn btn-primary px-4 ms-2">PDF</button>
                                </form>
                                @endif
                                @if(can_p('sale_wise_profit_report_print'))
                                <form action="{{ route('sale_wise_profit_report_print') }}" method="GET">
                                    <input type="hidden" value="{{ $from_date }}" name="p_from_date" class="p_from_date">
                                    <input type="hidden" value="{{ $to_date }}" name="p_to_date" class="p_to_date">
                                    <input type="hidden" value="{{request()->customer}}" name="p_customer" class="p_customer">
                                    <input type="hidden" value="{{request()->dsr}}" name="p_dsr">
                                ...
                                @endif
                                @if(can_p('sale_wise_profit_report_excel'))
                                <form action="{{ route('sale_wise_profit_report_excel') }}" method="GET">
                                    <input type="hidden" value="{{ $from_date }}" name="p_from_date" class="p_from_date">
                                    <input type="hidden" value="{{ $to_date }}" name="p_to_date" class="p_to_date">
                                    <input type="hidden" value="{{request()->customer}}" name="p_customer" class="p_customer">
                                    <input type="hidden" value="{{request()->dsr}}" name="p_dsr">
